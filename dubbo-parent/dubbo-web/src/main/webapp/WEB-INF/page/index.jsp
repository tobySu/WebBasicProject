...
<input type="hidden" id="ctxValue" value="${ctx}">
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="${ctx}/index/goPage.html?pathName=user/category/list" target="content" class="active" id="MenutopIten"><i class="fa fa-dashboard fa-fw"></i>首页</a>
                        </li>
                        <li>
                            <a href="#" id="MenutopIten"><i class="fa fa-bar-chart-o fa-fw"></i>用户管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
		                            <a href="${ctx}/index/goPage.html?pathName=user/list" target="content" id="menuItem"><i class="fa fa-user"></i>用户管理</a>
		                        </li>
                                <li>
                                    <a href="${ctx}/index/goPage.html?pathName=user/category/list" target="content" id="menuItem"><i class="fa fa-cubes"></i>用户分类管理</a>
                                </li>
                                
                                 <li>
                                    <a href="${ctx}/index/goPage.html?pathName=editor/editor" target="content" id="menuItem">ueditor</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div id="page-wrapper">
        	<iframe  src="${ctx}/index/goPage.html?pathName=user/category/list"  scrolling="auto" name="content" id="content"  onload="changeFrameHeight()" style="width:100%;border:0px"></iframe>
        </div>
        <!-- /#page-wrapper -->
		    ...
		    <div class="modal-dialog" role="document" id="firstDialog" style="position:absolute;width:auto;margin:10px auto;left:0;right:0;top:40%">  
		        <div class="modal-content">  
		            ...
		            <div class="modal-body" id="firstDialogBody">  
		               	<iframe  src="${ctx}/index/goPage.html?pathName=blank" id="firstDialogFrame"  style="width:100%;border:0px"></iframe>
		       		</div>  
		        </div>  
		    </div>  
		</div> 
