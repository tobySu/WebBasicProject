				...
				<tr>
					...
					<!-- 下面这个div必须要有，插件根据这个进行添加提示 -->
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="name" placeholder="请输入要新增的分类名称"/>
							</div>
						</div>
					</td>
				</tr>
				<tr>
					...
					<!-- 下面这个div必须要有，插件根据这个进行添加提示 -->
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="tagList" placeholder="请输入描述专属标签"/>
							</div>
						</div>
					</td>
				</tr>
				<tr>
					...
					<!-- 下面这个div必须要有，插件根据这个进行添加提示 -->
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="description" placeholder="请输入您的描述（400字内）"/>
							</div>
						</div>
					</td>
				</tr>
